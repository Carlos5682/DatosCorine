...
server <- function(input, output, session) {
  ...
  nombrecom_corregido <- reactive({
    URLencode(enc2utf8(input$comunidad), reserved = TRUE)
  })
  ...
  corine_n1_capa_completa <- reactive({
    ...
    url_geojson <- paste0(
      "https://github.com/Carlos5682/DatosCorine/raw/refs/heads/main/Capasfinales/Corine/",nombrecom_corregido,
      "/",
  ...
  corine_n1_capa_recortada <- reactive({
    ...
    url_geojson <- paste0("https://github.com/Carlos5682/DatosCorine/raw/refs/heads/main/Capasfinales/Corine/",nombrecom_corregido,
                          "/",
                          URLencode(nombre_corregido, reserved = TRUE),
                          ".geojson"
    )
